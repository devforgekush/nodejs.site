        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <div className="text-sm text-gray-600">Increase in ransomware attacks</div>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              <div className="text-4xl font-bold text-orange-600 mb-2">3.4B</div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <div className="text-sm text-gray-600">Attacks target small businesses</div>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              <div className="text-4xl font-bold text-blue-600 mb-2">11s</div>
              <div className="text-sm text-gray-600">Time between attacks</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-500">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">WannaCry Ransomware (2017)</h3>
              </div>
              <p className="text-gray-600 mb-4">
                Global ransomware attack that affected over 300,000 computers across 150 countries, causing billions in damages and disrupting critical services including healthcare systems.
              </p>
              <div className="text-sm text-gray-500">
                <strong>Impact:</strong> $4 billion in damages, 200,000+ victims
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Equifax Data Breach (2017)</h3>
              </div>
              <p className="text-gray-600 mb-4">
                Massive data breach exposing sensitive personal information of 147 million Americans, including Social Security numbers, birthdates, and addresses.
              </p>
              <div className="text-sm text-gray-500">
                <strong>Impact:</strong> 147 million affected, $700 million settlement
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">SolarWinds Supply Chain Attack (2020)</h3>
              </div>
              <p className="text-gray-600 mb-4">
                Sophisticated supply chain attack that compromised software used by thousands of organizations, including government agencies and Fortune 500 companies.
              </p>
              <div className="text-sm text-gray-500">
                <strong>Impact:</strong> 18,000+ organizations affected, ongoing investigation
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Colonial Pipeline Attack (2021)</h3>
              </div>
              <p className="text-gray-600 mb-4">
                Ransomware attack on critical infrastructure that shut down the largest fuel pipeline in the US for six days, causing widespread fuel shortages.
              </p>
              <div className="text-sm text-gray-500">
                <strong>Impact:</strong> $4.4 million ransom paid, nationwide fuel disruption
              </div>
            </div>
          </div>
        </div>
