...
export default function Glossary() {
  ...
  const glossaryTerms = [
    {
      term: "Antivirus",
      definition: "Software designed to detect, prevent, and remove malware from computers and networks."
    },
    {
      term: "Backup",
      definition: "A copy of data stored separately from the original to protect against data loss."
    },
    {
      term: "Botnet",
      definition: "A network of compromised computers controlled remotely by cybercriminals."
    },
    {
      term: "Brute Force Attack",
      definition: "A trial-and-error method used to obtain passwords or encryption keys by trying many combinations."
    },
    {
      term: "Cipher",
      definition: "An algorithm used to encrypt and decrypt data to protect its confidentiality."
    },
    {
      term: "Cloud Security",
      definition: "Policies, technologies, and controls deployed to protect data, applications, and infrastructure in cloud computing environments."
    },
    {
      term: "Cryptocurrency",
      definition: "Digital currency that uses cryptography for security and operates independently of central banks."
    },
    {
      term: "Cybercrime",
      definition: "Criminal activities carried out using computers or the internet as a tool or target."
    },
    {
      term: "DDoS Attack",
      definition: "Distributed Denial of Service attack that overwhelms a target with traffic from multiple sources."
    },
    {
      term: "Encryption",
    ...
    {
      term: "Endpoint",
      definition: "A device connected to a network, such as computers, smartphones, or IoT devices."
    },
    {
      term: "Firewall",
    ...
    {
      term: "Hacker",
      definition: "A person who uses technical skills to gain unauthorized access to computer systems."
    },
    {
      term: "Identity Theft",
      definition: "The fraudulent acquisition and use of another person's personal information."
    },
    {
    ...
    },
    {
      ...
      definition: "Network of interconnected devices that can collect and exchange data."
    },
    {
      term: "Keylogger",
      definition: "Software or hardware that records keystrokes to capture passwords and sensitive information."
    },
    {
      term: "Malware",
    ...
    },
    {
      ...
      definition: "Security process requiring multiple forms of verification to access an account."
    },
    {
      term: "Network Security",
      definition: "Practices and technologies designed to protect computer networks from unauthorized access."
    },
    {
      term: "Patch",
      definition: "Software update designed to fix security vulnerabilities or bugs."
    },
    {
      term: "Penetration Testing",
      definition: "Authorized simulated attack on a computer system to evaluate its security."
    },
    {
      term: "Phishing",
    ...
    },
    {
      ...
      definition: "Process of identifying, analyzing, and evaluating potential security threats."
    },
    {
    ...
    {
      term: "Spam",
      definition: "Unwanted or unsolicited electronic messages, typically sent in bulk."
    },
    {
      term: "Spyware",
      definition: "Malware that secretly gathers information about a user's activities."
    },
    {
      term: "SSL/TLS",
      definition: "Protocols that provide secure communication over computer networks."
    },
    {
      term: "Trojan Horse",
      definition: "Malware disguised as legitimate software to gain unauthorized access."
    },
    {
    ...
    {
      term: "Vulnerability",
      definition: "A weakness in a system that can be exploited by threats to gain unauthorized access."
    },
    {
    ...
    },
    {
      ...
      definition: "Attack that exploits a previously unknown vulnerability before a patch is available."
    },
    {
      term: "API Security",
      definition: "Protection of Application Programming Interfaces from attacks and misuse."
    },
    {
      term: "Biometric Authentication",
      definition: "Security process using unique biological characteristics for user verification."
    },
    {
      term: "Certificate Authority",
      definition: "Trusted entity that issues digital certificates to verify identity."
    },
    {
      term: "Data Breach",
      definition: "Unauthorized access to or disclosure of sensitive information."
    },
    {
      term: "Digital Forensics",
      definition: "Investigation of digital devices to recover and analyze evidence of cybercrimes."
    },
    {
      term: "Ethical Hacking",
      definition: "Authorized hacking performed to identify vulnerabilities and improve security."
    },
    {
      term: "Honeypot",
      definition: "Decoy system designed to attract and detect unauthorized access attempts."
    },
    {
      term: "Insider Threat",
      definition: "Security risk posed by people within an organization who have authorized access."
    },
    {
      term: "Machine Learning Security",
      definition: "Application of AI and ML techniques to enhance cybersecurity capabilities."
    },
    {
      term: "Password Manager",
      definition: "Software application that stores and manages passwords securely."
    },
    {
      term: "Sandbox",
      definition: "Isolated environment for testing potentially malicious software safely."
    },
    {
      term: "Threat Intelligence",
      definition: "Information about current and emerging security threats and vulnerabilities."
    },
    {
      term: "Whaling",
      definition: "Phishing attack specifically targeting high-profile individuals like executives."
    }
  ];
  ...
  const groupedTerms = filteredTerms.reduce<Record<string, typeof glossaryTerms>>( (acc, term) => {
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-blue-600 mb-2">{glossaryTerms.length}+</div>
              <div className="text-gray-600">Terms Defined</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600 mb-2">{Object.keys(groupedTerms).length}</div>
